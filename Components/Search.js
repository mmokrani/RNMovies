...
class Search extends React.Component {
  ...
  _navigateToFilmDetail = (idFilm) => {
    console.log("idFilm : " + idFilm)
    this.props.navigation.navigate('DetailNav', {idFilm: idFilm})
  }
    ...
    return (
      <View style={styles.main_container}>
        ...
        <FlatList
          ...
          renderItem={({item}) => <FilmItem film={item} displayDetailForFilm={this._navigateToFilmDetail}/>}
